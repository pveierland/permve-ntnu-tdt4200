...
\begin{figure}
\begin{tikzpicture}
\begin{axis}[xlabel={Program run},ylabel={Running time [us]},legend pos=outer north east,legend style={font=\footnotesize}]
\addplot table[x index=0,y index=1,col sep=comma] {../data/lenna_20_32.txt};
\addplot table[x index=0,y index=2,col sep=comma] {../data/lenna_20_32.txt};
\addplot table[x index=0,y index=3,col sep=comma] {../data/lenna_20_32.txt};
\addplot table[x index=0,y index=4,col sep=comma] {../data/lenna_20_32.txt};
\addplot table[x index=0,y index=5,col sep=comma] {../data/lenna_20_32.txt};
\addlegendentry{cudaMalloc}
\addlegendentry{cudaMemcpyHostToDevice}
\addlegendentry{invert\_pixels}
\addlegendentry{cudaMemcpyDeviceToHost}
\addlegendentry{cudaFree}
\end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
\begin{axis}[xlabel={Program run},ylabel={Running time [us]},legend pos=outer north east,legend style={font=\footnotesize}]
\addplot table[x index=0,y index=1,col sep=comma] {../data/lenna_384_256.txt};
\addplot table[x index=0,y index=2,col sep=comma] {../data/lenna_384_256.txt};
\addplot table[x index=0,y index=3,col sep=comma] {../data/lenna_384_256.txt};
\addplot table[x index=0,y index=4,col sep=comma] {../data/lenna_384_256.txt};
\addplot table[x index=0,y index=5,col sep=comma] {../data/lenna_384_256.txt};
\addlegendentry{cudaMalloc}
\addlegendentry{cudaMemcpyHostToDevice}
\addlegendentry{invert\_pixels}
\addlegendentry{cudaMemcpyDeviceToHost}
